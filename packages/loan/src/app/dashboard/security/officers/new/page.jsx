...
export default function NewOfficer() {
    ...
    const { data: dataCreated, createResource } = useCreateResource(BASE_URL, 'officers/create');
    ...
    const handleSubmit = async (e) => {
        ...
        await createResource(newResource, '/dashboard/security/officers');
    };
    ...
    return (
        <DashboardContainerWrapper>
            <DashboardHeading title="New Officer" />
