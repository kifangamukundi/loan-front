...
export default function Products() {
  ...
  return (
    <div className="px-4">
        <DashboardAddNewItem title='Add New Product' link='/dashboard/shop/products/new' loading={data.loading} />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
            <DashbordSearchbar placeholder='Search for Products' search={search} change={handleSearchChange} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {data?.data?.posts?.map(item => (
                <DashboardAdvancedCard 
                    ...
                    editLink={`/dashboard/shop/products/edit/${item.id}`}
