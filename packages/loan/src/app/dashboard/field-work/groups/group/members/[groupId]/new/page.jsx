...
export default function NewMember() {
    ...
    const { data: dataCreated, createResource } = useCreateResource(BASE_URL, 'members/create');
    ...
    const handleSubmit = async (e) => {
        ...
        const newResource = {
            ...
            Groups: Array.isArray(groupId) ? groupId.map(groupId => parseInt(groupId, 10)) : [parseInt(groupId, 10)]
        };
        await createResource(newResource, `/dashboard/field-work/groups/group/members/${groupId}`);
    };
    ...
    return (
        <DashboardContainerWrapper>
            <DashboardHeading title="New Member" />
